#
# Be sure to run `pod lib lint FRCircleSlider.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of FRCircleSlider.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'FRCircleSlider/Classes/**/*'
  
  # s.resource_bundles = {
  #   'FRCircleSlider' => ['FRCircleSlider/Assets/*.png']
  # }
